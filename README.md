...
See [`SPEC.md`](./SPEC.md) for the full step-by-step record of what was
built and why, including the architecture decisions (why DynamoDB isn't
"inside" a VPC, why an Internet Gateway was used instead of a NAT Gateway,
etc.) and the exact resource IDs created.
